...
class Config {
  ...
  /// Generated by SiteNative 05-08-2022 08:58:31
  /// App UID: 3bee25a5-4dd8-90e2-eea0-a0a6deb566f2
  /// Version: http://webapp.chaloonline.shopbackend/
  /// API server: {VERSION}

  /// *** App config *** ///
  // App name
  static String appName = "rudraskha";
  // App link
  static String appLink = "https://shritrilokeshwarmahadev.com/";
  ...
  // Admin email
  static String appEmail = "himanshuj331@gmail.com";
  // Template
  ...
  /// *** Drawer settings *** ///
  // Title
  static String drawerTitle = "trilok";
  // Subtitle
  ...
  // Signing
  static String osSigning = "2028ba1f7304f004c79b21e875e098f18ab09a04b41728c3a2f70675bc6ec285";
  // Enabled android?
  ...
  static List<NavigationItem> mainNavigation = [
    	NavigationItem(name: "call",icon: "call-sharp.svg",type: ActionType.phone,value: "7004965845",),

  ];
  // Bar app navigation
  static List<NavigationItem> barNavigation = [
    	NavigationItem(name: "email",icon: "mail-sharp.svg",type: ActionType.email,value: "prdmn.shrm@gmail.com",),

  ];
  // Modal navigation
  static List<NavigationItem> modalNavigation = [
    	NavigationItem(name: "more",icon: "add-circle-sharp.svg",type: ActionType.openModal,value: "",),
